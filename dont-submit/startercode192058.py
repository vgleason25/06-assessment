...
def read_dictionary_file():
    ...
    # Store each word in a list. = my_dictionary
...
def read_wheel_txt_file():
    ...
    # read the Wheel name from input using the Config wheel_loc file location 
...
def wof_round_setup():
    ...
    # Use getWord function to retrieve the word and the underscore word (blank_word)
...
def wof_final_round():
    ...
    # Use the getWord function to reset the round_word and the blank_word ( word with the underscores)
    ...
    # Remember guess_letter should fill in the letters with the positions in blank_word 
