...
def final_guess_letters(final_letters):# removed 'player_num' from () # defines if given and choosen letters are in the puzzle:
...
def solve_puzzle(player_num, round_num):
    ...
    time.sleep(2) # pause again for more dramatic effect!
    if answer == raw_round_word: #TODO i dont think this is correct
...
def wof_final_round():
    ...
    final_guess_letters(final_letters)
